--// GUI Check //--
if game:GetService("CoreGui"):FindFirstChild("PrisonXGUI") then
game:GetService("CoreGui").PrisonXGUI:Destroy()
end

if game:GetService("CoreGui"):FindFirstChild("PrisonXSTGUI") then
game:GetService("CoreGui").PrisonXSTGUI:Destroy()
end

--// Modified Library //--
local library =
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Sjorbiia/X-Scripts/master/UILibrary", true))()
library.options.underlinecolor = "rainbow"

--// Settings Window //--
local wset = library:CreateWindow("Settings 1")
wset:Section("Color Selection")
wset:SearchBox(
        "Colors",
        {
            location = _G,
...
wset:Section("Features")

local t = wset:Toggle("Swat Gamepass Features", {flag = "sgf"})

local t = wset:Toggle("Smaller Items Tab", {flag = "smita"})

local t = wset:Toggle("Quick Gun Mods", {flag = "qgnmds"})

wset:Section("Options")

wset:Button("Load GUI", function()
game:GetService("CoreGui").PrisonXSTGUI:Destroy()
local library =
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Sjorbiia/X-Scripts/master/UILibrary", true))()
...
if _G.colors == "Red" then
    library.options.underlinecolor = Color3.fromRGB(255, 0, 0)
elseif _G.colors == "Orange" then
    library.options.underlinecolor = Color3.fromRGB(255, 150, 0)
elseif _G.colors == "Yellow" then
    library.options.underlinecolor = Color3.fromRGB(255, 255, 0)
elseif _G.colors == "Green" then
    library.options.underlinecolor = Color3.fromRGB(0, 255, 0)
elseif _G.colors == "Teal" then
    library.options.underlinecolor = Color3.fromRGB(0, 255, 150)
elseif _G.colors == "Blue" then
    library.options.underlinecolor = Color3.fromRGB(0, 0, 255)
elseif _G.colors == "Purple" then
    library.options.underlinecolor = Color3.fromRGB(150, 0, 255)
elseif _G.colors == "Pink" then
    library.options.underlinecolor = Color3.fromRGB(255, 0, 150)
elseif _G.colors == "Rainbow" then
    library.options.underlinecolor = "rainbow"
else
    library.options.underlinecolor = "rainbow"
end
                ...
                function(new)
                    if _G.tools == "Riot Shield" then
                        if game:GetService("Players").LocalPlayer.Team == game:GetService("Teams")["Inmates"] then
                            ...
                            Workspace.Remote.ItemHandler:InvokeServer(
                                Workspace.Prison_ITEMS.single["Riot Shield"].ITEMPICKUP
                            )
                        ...
                        if _G.tools == "Crude Knife" then
                            if game:GetService("Players").LocalPlayer.Team == game:GetService("Teams")["Guards"] then
                                Workspace.Remote.TeamEvent:FireServer("Bright orange")
                                Workspace.Remote.ItemHandler:InvokeServer(
                                    Workspace.Prison_ITEMS.single["Crude Knife"].ITEMPICKUP
                                )
                                Workspace.Remote.TeamEvent:FireServer("Bright blue")
                            else
                                Workspace.Remote.ItemHandler:InvokeServer(
                            ...
                            if _G.tools == "Hammer" then
                                if game:GetService("Players").LocalPlayer.Team == game:GetService("Teams")["Guards"] then
                                    Workspace.Remote.TeamEvent:FireServer("Bright orange")
                                    Workspace.Remote.ItemHandler:InvokeServer(
                                        Workspace.Prison_ITEMS.single["Hammer"].ITEMPICKUP
                                    )
                                    Workspace.Remote.TeamEvent:FireServer("Bright blue")
                                else
                                    Workspace.Remote.ItemHandler:InvokeServer(
                ...
                if _G.modguns == "All" then
                    ...
                    if _G.modguns == "M4A1" then
                        ...
                        if _G.modguns == "AK-47" then
                            ...
                            if _G.modguns == "Remington 870" then
                                local player = game:GetService("Players").LocalPlayer
                                ...
                                if _G.modguns == "M9" then
                                    ...
                                    if _G.modguns == "Taser (No Damage)" then
                                        local player = game:GetService("Players").LocalPlayer
...
if SwatGamepass == true then
w2:Button("Get Modded Guns", function()
Workspace.Remote.ItemHandler:InvokeServer(Workspace.Prison_ITEMS.giver["M4A1"].ITEMPICKUP)
Workspace.Remote.ItemHandler:InvokeServer(Workspace.Prison_ITEMS.giver["AK-47"].ITEMPICKUP)
Workspace.Remote.ItemHandler:InvokeServer(Workspace.Prison_ITEMS.giver["Remington 870"].ITEMPICKUP)
Workspace.Remote.ItemHandler:InvokeServer(Workspace.Prison_ITEMS.giver["M9"].ITEMPICKUP)
...
w3:Section("Health")
    local t =
        ...
        {flag = "gmtgl"},
        function()
if w3.flags.gmtgl then
while w3.flags.gmtgl do
wait()
...
w3:Button("No Fence Damage", function()
...
w4:Button("Name Color", function()
Workspace.Remote.TeamEvent:FireServer("Bright yellow")
end)
end
            ...
            if _G.toggleable == "Fly (Q to toggle)" then
                ...
                if humanoid.RigType == Enum.HumanoidRigType.R15 then
                    ...
                    until game:GetService "Players".LocalPlayer and game:GetService "Players".LocalPlayer.Character and
                        game:GetService "Players".LocalPlayer.Character:findFirstChild("UpperTorso") and
                        game:GetService "Players".LocalPlayer.Character:findFirstChild("Humanoida")
                    ...
                    function Fly()
                        ...
                        repeat
                            ...
                            if (ctrl.l + ctrl.r) ~= 0 or (ctrl.f + ctrl.b) ~= 0 then
                                bv.velocity =
                                    ((game:GetService("Workspace").CurrentCamera.CoordinateFrame.lookVector *
                                    (ctrl.f + ctrl.b)) +
            ...
            if _G.gunmods == "FE Drill" then
                ...
                for index, tool in pairs(LocalPlayer:GetChildren()) do
                    if tool:IsA("Tool") then
                        ...
                        tool.Grip =
                            CFrame.new(Vector3.new(0, -index * .1, 0)) *
            ...
            elseif _G.gunmods == "FE Bowl" then
                ...
                for index, tool in pairs(LocalPlayer:GetChildren()) do
                    if tool:IsA("Tool") then
                        ...
                        tool.Grip =
                            CFrame.new(Vector3.new(math.sin(index * 0.1), bowlsize, 0)) *
            ...
            elseif _G.gunmods == "FE Waves" then
                ...
                for index, tool in pairs(LocalPlayer:GetChildren()) do
                    if tool:IsA("Tool") then
                        ...
                        tool.Handle.Massless = false
                        tool.Grip =
                            CFrame.new(Vector3.new(0, math.sin(index + 0.5), index)) *
                ...
                function OCC()
                    if OCV == "Open" then
                        local tween1 =
                            TweenService:Create(
                            OC,
                             --whatever should be tweened
                            TweenInfo.new(0.6),
                             --how the tween should act
                            {
                                Rotation = -180
                             --set rotation to whatever it should be
                            }
                        )
...
local player = game:GetService("Players").LocalPlayer
	for i,v in pairs(player:FindFirstChildOfClass("Backpack"):GetChildren()) do
		if v:IsA("Tool") or v:IsA("HopperBin") then
            if v.Name == "AK-47" or v.Name == "Remington 870" then
            ...
            elseif _G.ctools == "Spear" then
                ...
                tool2.Equipped:connect(
                    function()
                        tool2.Activated:connect(
                            function()
                                if db == true then
                                    db = false
                                    m:Play()
            ...
            elseif _G.ctools == "Hellbringer" then
                workspace.Remote.ItemHandler:InvokeServer(Workspace.Prison_ITEMS.single["Hammer"].ITEMPICKUP)
                ...
                tool.GripPos = Vector3.new(0.1, -1, 0)
                tool.Name = "Hellbringer"

                local k = tool.Handle

                tool.Part.Name = "Part2"

                tool.Part2.Material = Enum.Material.Neon

                tool.Part2.Color = Color3.fromRGB(255, 50, 10)

                tool.Part.Material = Enum.Material.Neon

                tool.Part.Color = Color3.fromRGB(255, 50, 10)
    ...
    w6:Dropdown(
        ...
        function(new)
            if _G.pts == "Prison Courtyard" then
                ...
                if _G.pts == "Prison Cellblock" then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                        CFrame.new(
                        916.858215,
                        99.9899902,
                    ...
                    if _G.pts == "Prison Cafeteria" then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                            CFrame.new(
                            920.90387,
                            99.9899597,
...
game:GetService("CoreGui").ScreenGui.Name = "PrisonXGUI"
...
game:GetService("CoreGui").ScreenGui.Name = "PrisonXSTGUI"
